...
<template>
    <section class="bg-stone-600/90" id="aboutus">
        <div class="w-full h-30">

        </div>
        <div class="container mx-auto py-16 px-10 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
                ...
                <div class="mt-12 md:mt-0">
                    <img src="https://media.istockphoto.com/id/1990903547/video/family-roof-or-hands-together-for-portrait-of-kids-on-floor-in-living-room-at-home-for.jpg?s=640x640&k=20&c=3qSbctb8bdR7CYn0wxu9cLlJV6r7wlme-KZaTUlv9KM="
        ...
        <div class="flex justify-center text-3xl font-bold text-amber-950  font-['Poppins'] text-center">
            Why Us?
        </div>
            ...
            <div class="flex flex-wrap text-center justify-center">
                <div class="p-4 md:w-1/4 sm:w-1/2">
                    <div class="px-4 py-6 transform transition duration-500 hover:scale-110">
                        ...
                        <h2 class="title-font font-regular text-2xl text-gray-900">Qualiry Products</h2>
                    </div>
                </div>
