...
<template>
    <section class="bg-stone-600/90">
        <div class="w-full h-30">

        </div>
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:py-20 lg:px-8">
        <div class="max-w-2xl lg:max-w-4xl mx-auto text-center">
            <h2 class="text-3xl font-extrabold text-amber-950 font-['Poppins']" id="contactUs">Visit Our Showroom</h2>
            <p class="mt-3 text-lg  text-amber-950 font-['Poppins']">Let us serve you the best</p>
        </div>
                ...
                <div>
                    <div class="max-w-full mx-auto rounded-lg overflow-hidden">
                        <div class="border-t border-gray-200 px-6 py-4">
                            <h3 class="text-lg font-bold text-amber-950 font-['Poppins']">Contact</h3>
                            <p class="mt-1 font-bold text-amber-950 font-['Poppins']"><a href="tel:+123">Phone: +91
                                    123456789</a></p>
                            <a class="flex m-1" href="tel:+919823331842">
                                <div class="flex-shrink-0">
                                    <div
                                        class="flex items-center justify-between h-10 w-30 rounded-md bg-[#c09858] C p-2">
                                        <!-- Heroicon name: phone -->
                        ...
                        <div class="px-6 py-4">
                            <h3 class="text-lg font-medium text-amber-950 font-['Poppins']">Our Address</h3>
                            <p class="mt-1 text-amber-950 font-['Poppins']">Sale galli, 60 foot road, Latur</p>
                        </div>
                        <div class="border-t border-[#c09858] text-amber-950 font-['Poppins'] px-6 py-4">
                            <h3 class="text-lg font-medium ">Hours</h3>
                            <p class="mt-1 text-amber-950 font-['Poppins']">Monday - Sunday : 2pm - 9pm</p>
                        </div>
                    </div>
                </div>
